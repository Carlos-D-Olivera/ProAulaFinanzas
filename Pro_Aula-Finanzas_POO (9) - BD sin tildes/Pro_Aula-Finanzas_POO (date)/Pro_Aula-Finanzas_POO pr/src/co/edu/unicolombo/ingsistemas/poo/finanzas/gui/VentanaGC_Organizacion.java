...
import co.edu.unicolombo.ingsistemas.poo.finanzas.crudl.ClienteOrganizacionJpaController;
 ...
 * @author jimmy
 */
public class VentanaGC_Organizacion extends javax.swing.JDialog {

    /**
     * Creates new form VentanaUsuario
     */
    public VentanaGC_Organizacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        campoNEmpleados = new javax.swing.JTextField();
        ...
        etiquetaImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/co/edu/unicolombo/ingsistemas/poo/finanzas/icon/userCompany 126px.png"))); // NOI18N
        ...
        tituloFormulario.setText("Formulario de gestion de clientes de tipo organización");

        panelFormulario.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 102, 255), 3, true), "Datos de la organización", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        campoTipoOrganizacion.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        campoTipoOrganizacion.setHorizontalAlignment(javax.swing.JTextField.LEFT);

        Jlabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Jlabel6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        Jlabel6.setText("N° de empleados:");

        campoNEmpleados.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        campoNEmpleados.setHorizontalAlignment(javax.swing.JTextField.LEFT);

        Jlabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Jlabel7.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        Jlabel7.setText("Representante:");

        campoRepresentante.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        campoRepresentante.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        panelFormularioLayout.setVerticalGroup(
            ...
            .addGroup(panelFormularioLayout.createSequentialGroup()
                ...
                .addGroup(panelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(campoNEmpleados, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(panelFormulario, javax.swing.GroupLayout.PREFERRED_SIZE, 338, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        ...
        String dirrecion= campoDireccion.getText();
        String nit= campoNit.getText();
        String email= campoEmail.getText();
        String tipoOrganizacion= campoTipoOrganizacion.getText();
        int numeroEmpleados= Integer.parseInt(campoNEmpleados.getText());
...
//        co.setDirección(dirrecion);
//        co.setNombre(nombre);
//        co.setEmail(email);
//        co.setContraseña(contraseña);
        co.setNit(nit);
        co.setTipoOrganizacion(tipoOrganizacion);
        co.setNoEmpleados(numeroEmpleados);
       
        EntityManagerFactory conexionBd= Persistence.createEntityManagerFactory("Pro_Aula-Finanzas_POOPU");
        ClienteOrganizacionJpaController crudl = new ClienteOrganizacionJpaController(conexionBd);
        try {
            
            crudl.create(co);
            int total= crudl.getClienteOrganizacionCount();
            JOptionPane.showMessageDialog(null,"Registro realizado con exito!!.\n Total: "+total);
        } catch (PreexistingEntityException ex) {
            JOptionPane.showMessageDialog(null,"Ya existe un cliente con este nit: "+nit);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaGC_Organizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaGC_Organizacion dialog = new VentanaGC_Organizacion(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField campoNEmpleados;
